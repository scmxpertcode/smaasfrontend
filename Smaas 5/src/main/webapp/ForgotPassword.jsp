				...
				<div class="user_card">
					...
					<div class="d-flex justify-content-center form_container">
							...
							<div class="input-group mb-3" id="usertext1">
								...
								<div id="errorForgotEail" style="color: red;text-align: center;font-weight: bold;"></div>
							</div>
						<!-- <div class="input-group mb-2">
							...
							<div class="input-group mb-2">
								...
								<input type="password" name="con-password" id="con-password" class="form-control input_pass" required placeholder="Con-Form New Password">
							</div> -->
						
					</div>
					<div class="d-flex justify-content-center mt-3 login_container">
						<button type="submit" class="btn login_btn" onclick="javascript:return forgotsendEmail();">Submit</button>
