...
content="script-src: 'self' 'strict-dynamic' 'nonce-rAnd0m123' 'unsafe-inline' http: https:;'
default-src 'self';
frame-src 'self';
font-src *;
object-src 'none';
				...
				<div class="user_card">
					...
					<div class="d-flex justify-content-center form_container">
							...
							<div class="input-group mb-3" id="usertext1">
								...
								<input type="text" name="Business Partner Id" id="username" class="form-control input_user" required placeholder="Business Partner Id" style="">
							</div>
							<div class="input-group mb-2">
								<div class="input-group-append">
									<span class="input-group-text"><i class="fa fa-key" style="font-size: 16px;" aria-hidden="true"></i></span>
								</div>
								<input type="password" name="password" id="password" class="form-control input_pass" required placeholder="Password" style="position:absolute;z-index: 1;" onkeypress="javascript:return keycodecheck(event)">
								<img src="./images/showpassword.jpg" style="width:25px;" id="showPassword" onclick="javascript:return ShowPassword();" title="Show Password"/>
								<img src="./images/Hidepassword.jpg" style="width:25px;" id="hidePassword" onclick="javascript:return ShowPassword();" title="Hide Password"/>
							</div>
						
					</div>
					<div class="d-flex justify-content-center mt-3 login_container">
						<button type="submit" class="btn login_btn" onclick="javascript:loginToDashboard()">Login</button>
						<button type="button" class="btn login_btn" onclick="window.location.href='index.jsp'">Cancel</button>	
					</div>
					<div align="center"><ul>
					<a href="#" onclick="javascript:return fogotPassword();" class="forgotPassword" style="color:#fff;">Forgot Password</a>
					</ul>
